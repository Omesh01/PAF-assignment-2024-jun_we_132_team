...
import { Avatar, Button, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, Menu, MenuItem, TextField } from '@mui/material';
...
import UpdateMeal from './UpdateShare';
          ...
          <div className="flex justify-between items-center ">
            ...
            <div>
              ...
              >
                ...
                {twit.user.id === auth.user.id && <MenuItem onClick={handleClickOpen}>Edit</MenuItem>}
