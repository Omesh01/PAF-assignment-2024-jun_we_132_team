import { Avatar, Backdrop, Box, Button, Checkbox, CircularProgress } from '@mui/material';
...
const MealSection = () => {
  ...
  useEffect(() => {
    ...
    const filteredFoods = twit.twits.filter(food => food.isMeal === 'share');
  ...
  return (
    <div className="space-y-5">
      <section>
        <h1 className="py-5 text-xl font-bold opacity-90">Shared Posts</h1>
      </section>
      <section
        className={`pb-10 ${
