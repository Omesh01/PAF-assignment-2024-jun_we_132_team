...
export const UPDATE_TWEET_REQUEST='UPDATE_USER_REQUEST';
export const UPDATE_TWEET_SUCCESS='UPDATE_USER_SUCCESS';
export const UPDATE_TWEET_FAILURE='UPDATE_USER_FAILURE';
